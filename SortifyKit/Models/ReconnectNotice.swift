...
public enum ReconnectNotice {
    ...
    public static let collaborative = "Playlists shared with you aren't showing. Sortify needs one more permission from Spotify to see them - reconnecting grants it."
