    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section {
                    FAQItem(
                        ...
                        answer: """
                            ...
                            app registered after that date, and never shipped a replacement. Sortify \
                ...
                Section("Credits") {
                    Text("Sortify is an iOS port of Paul Lamere's Sort Your Music, which has been sorting playlists on the web since 2012.")
                        .font(.footnote)
