...
/// Sorty's mark: four pills of descending length, a set of things put in
/// order.
///
...
struct SortyMarkTile: View {
    var side: Double = 72

    var body: some View {
        SortyMark()
            .frame(width: side, height: side)
            .background(SortyTheme.accent, in: .rect(cornerRadius: side * 0.22))
    }
}
